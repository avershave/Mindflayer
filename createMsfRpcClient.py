...
class createMsfRpcClient:
    ...
    def __init__(self):
        ...
        # Objects
        self.connectMsfRpcClient = connectMsfRpcClient(self.username, self.password, self.port, self.host, self.ssl)

        # Connect to msfrpcd
        if self.connectMsfRpcClient.connect() is False:
            sys.exit()